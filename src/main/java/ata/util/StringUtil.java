...
public class StringUtil
{
     ...
     * StringUtils.equalsIgnoreCase("abc", "abc") = true
     * StringUtils.equalsIgnoreCase("abc", "ABC") = true
     * StringUtils.equalsIgnoreCase("a bc", "ABC ") = true
     * @param str1
     * @param str2
     * @return
     */
    public static boolean equalscustom(String str1, String str2)
    {
    	//中英文
 ...
 // Reversing
    ...
    //-----------------------------------------------------------------------
    /**
     * <p>ConvertUnicodeToJsonFormatL a String as per {@link StringBuffer#reverse()}.</p>
     *
     * <p>A <code>null</code> String returns <code>null</code>.</p>
     * number 不需要换行  则直接使用空格代替
     * <pre>
     * StringUtils.ConvertUnicodeToJsonFormatL(null)  = null
     * StringUtils.ConvertUnicodeToJsonFormatL("")    = ""
     * StringUtils.ConvertUnicodeToJsonFormatL("bat") = "tab"
     * </pre>
     *
     * @param str  the String to reverse, may be null
     * @return the reversed String, <code>null</code> if null String input
     */
    public static String ConvertUnicodeToJsonFormatL(String str , int number)
    {
        ...
        for (char ch : str.toCharArray()) {
			...
			case '>' :	  //大于
			    ...
			    break;
			case '©' :	  //版权
				sbuilder.append("&copy;");
			    break;
			case '®' :	  //已注册商标
				sbuilder.append("&reg;");
			    break;
			case '×' :	  //乘号
				sbuilder.append("&times;");
			    break;
			case '÷' :	  //除号
    ...
    public static String ToHtmlEscape(String text, boolean enterIsNewLine)
    {
